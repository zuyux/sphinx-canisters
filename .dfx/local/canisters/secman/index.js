...
import { idlFactory } from './secman.did.js';
export { idlFactory } from './secman.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_SECMAN;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./secman.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the secman canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./secman.did.js")._SERVICE>}
 */
export const secman = createActor(canisterId);
